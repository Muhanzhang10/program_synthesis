...
with open(f"{question}/experiment3.json", "r") as f:
    d = json.load(f)
...
def plot_all():
    ...
    fig.suptitle("TextJustification -mixtral-8x7b-32768 -Select best optimization")
...
def average():
    ...
    plt.title("Select best- Average pass rate for all runs at every iteration")
